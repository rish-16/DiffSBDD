...
for pdb_fn in PATH_contents:
    if "_bonds" in pdb_fn:
        ...
        print (f"python generate_ligands.py ckpt/moad_fullatom_cond.ckpt --pdbfile  analysis_combined_pdbs/combined_{pdb_name}/{pdb_fn} --outdir cg_results/{pdb_name}_results_aa/ --ref_ligand X:92")
